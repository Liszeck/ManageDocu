...
namespace ManageDocu
{
    public partial class Form1 : Form
    {
        ...
        {
            cn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\user\Desktop\ManageDocu\ManageDocu\Components\Database.mdf;Integrated Security=True");
            cn.Open();
        }
